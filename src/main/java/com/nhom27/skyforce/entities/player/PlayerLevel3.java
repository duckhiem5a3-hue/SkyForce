...
public class PlayerLevel3 extends Player {
    ...
    public PlayerLevel3(double startX, double startY) {
        super("player_ship_lv3_blue_idle", startX, startY);
        this.level = 3;
        this.damage = 50;
        this.fireRate = 140;
        this.maxHealth = 200;
        ...
        this.currentBulletTexture = "bullet_player_3";
    ...
    public List<Bullet> fireBullet(List<EnemyObject> enemies) {
        ...
        Bullet bCenter = new Bullet(currentBulletTexture, centerX, startY, 0, speedBulletY, damage);
        Bullet bLeft = new Bullet(currentBulletTexture, centerX - 12, startY, vxLeft, vyLeft, damage);
        Bullet bRight = new Bullet(currentBulletTexture, centerX + 12, startY, vxRight, vyRight, damage);
